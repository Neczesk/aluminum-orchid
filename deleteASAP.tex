...
\begin{document}
 ...
 \textit{\parbox{\textwidth}{The mighty furnace...}}
...
\hline
\begin{center} Wood: \\[5pt] \includegraphics[width=24pt,height=24pt]{pic/Wood.png}\end{center} & \begin{center} Steel: \\[5pt] \includegraphics[width=24pt,height=24pt]{pic/Steel.png}\hspace{12pt}\includegraphics[width=24pt,height=24pt]{pic/Steel.png}\end{center}\\
\hline
...
This lets you make things

\begin{itemize}
\item{Yep, still just makes things}
\end{itemize}
