...
\begin{document}
	\begin{center}
		\huge Faction Name
	\end{center}
	\parbox{\textwidth}{\normalsize \input{FactionDescriptions/loremipsum.tex}\par}
    ...
    \small\paragraph{}Ability 4\input{FactionRules/loremipsum.tex}\par
    \bigskip
    \noindent\large \textbf{Ability 5:}
    \small\paragraph{}Ability 5\input{FactionRules/loremipsum.tex}\par
    \bigskip
\end{document}
