...
\begin{document}
	...
	\end{center}
	\parbox{\textwidth}{\normalsize \input{FactionDescriptions/blackrobesdescription.tex}\par}
    ...
    \small\paragraph{}\input{FactionRules/castritual.tex}\par
    \bigskip
    \noindent\large \textbf{Learn Magic:}
    \small\paragraph{}\input{FactionRules/learnmagic.tex}\par
    \bigskip
\end{document}
