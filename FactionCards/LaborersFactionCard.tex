...
\begin{document}
	\begin{center}
		\huge The Laborers
	\end{center}
	\parbox{\textwidth}{\normalsize \input{FactionDescriptions/Laborersdescription.tex}\par}
    ...
    \bigskip
    \noindent\large \textbf{Landscape Engineering:}
    \small\paragraph{}\input{FactionRules/landscapeengineering.tex}\par
    \bigskip
    \noindent\large \textbf{Clear Land:}
    \small\paragraph{}\input{FactionRules/clearland.tex}\par
    \bigskip
\end{document}
